// Пакет ftracker выполняет функции подсчета необходимых параметров для трекера активности при 3х видах тренировок
//
// Тренировки:
//
// Бег, Хотьба, Плавание
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	meanWalkingSpeed := meanSpeed(action, duration) * kmhInMsec
	return (walkingCaloriesWeightMultiplier*weight + (math.Pow(meanWalkingSpeed, 2)/(height/cmInM))*walkingSpeedHeightMultiplier*weight) * duration * minInH
}
